...
//             Lexems[Pos].RW != reserved::texture     &&
...
//      {
//        if (Lexems[Pos].Type != lexem_type::reserved || 
//            (Lexems[Pos].RW != reserved::texproc))
//        {
//          error::msg(error::parser,
//                     "Unknown environment parameter in " + std::to_string(Lexems[Pos].Line) + " line.");
//          return FALSE;
...
//          break;
    ...
    //    }
    //  }
    //  raytracer::Get().Textures.Add(Name, Tex);
    //  return TRUE;
    //} /* End of 'ReadTexture' function */
    ...
    //      break;
    //    }
    //    case reserved::texture:
    //    {
    //      std::string Mat;
    //      if (!ReadName(&Mat))
    //        return FALSE;
    //      if ((Plane.Tex = raytracer::Get().Textures.Get(Mat)) == nullptr)
    //      {
    //        error::msg(error::parser,
    //          "Texture with name " + Mat + " does not exist. Line: " + std::to_string(Lexems[Pos].Line) + ".");
    //        return FALSE;
    //      }
    //      break;
    //    }
    ...
    //      if (!ReadName(&Mat))
    //        return FALSE;
    //      if ((Box.Tex = raytracer::Get().Textures.Get(Mat)) == nullptr)
    //      {
    //        error::msg(error::parser,
    //          "Texture with name " + Mat + " does not exist. Line: " + std::to_string(Lexems[Pos].Line) + ".");
    //        return FALSE;
    ...
    //      if (!ReadName(&Mat))
    //        return FALSE;
    //      if ((Sph.Tex = raytracer::Get().Textures.Get(Mat)) == nullptr)
    //      {
    //        error::msg(error::parser,
    //          "Texture with name " + Mat + " does not exist. Line: " + std::to_string(Lexems[Pos].Line) + ".");
    //        return FALSE;
    ...
    //      if (!ReadName(&Mat))
    //        return FALSE;
    //      if ((Obj.Tex = raytracer::Get().Textures.Get(Mat)) == nullptr)
    //      {
    //        error::msg(error::parser,
    //          "Texture with name " + Mat + " does not exist. Line: " + std::to_string(Lexems[Pos].Line) + ".");
    //        return FALSE;
    ...
    //    PARSERCASE(reserved::texture,     ReadTexture());
...
//          Tmp == "texture"       ? (L.RW = reserved::texture)     :
//          Tmp == "proc"          ? (L.RW = reserved::texproc)     :
